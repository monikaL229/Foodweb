  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cos-3 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#menu" className="hover:text-indigo-500">Menu</a></li>
          ...
          <div>
            ...
            <p className="mb-2">123 Food Street, Delicious City, DC 45678</p>
            <p className="mb-2">Email: <a href="mailto:info@foodweb.com" className="hover:text-indigo-500">info@foodweb.com</a></p>
            <p className="mb-2">Phone: <a href="tel:+1234567890" className="hover:text-indigo-500">+1 234-567-890</a></p>
          </div>
